...
public class SwerveDrivetrain extends SubsystemBase {
    ...
    public SwerveDrivetrain(AHRS gyro, SwerveModule swerveModuleFL, SwerveModule swerveModuleFR, SwerveModule swerveModuleBL, SwerveModule swerveModuleBR) {
		...
		odometry = new SwerveDriveOdometry(kinematics, gyro.getRotation2d(), modules(SwerveModule::getPosition, SwerveModulePosition[]::new));
    }
    ...
    public void resetPosition() {
        odometry.resetPosition(gyro.getRotation2d(), modules(SwerveModule::getPosition, SwerveModulePosition[]::new), pose);
    }
     ...
     * @return the current yaw value from -180 to 180 degrees. 0 whatever direction the robot starts in.
     */
