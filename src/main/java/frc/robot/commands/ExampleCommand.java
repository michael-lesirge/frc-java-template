...
public class ExampleCommand extends CommandBase {
     ...
     * it's ready for use.
     * This can take in any arguments you need. It normally uses 1 subsystem (but
     * can take multiple when necessary), as wells as arguments for what to do, such
     * as a joystick in the drive command or a desired position in an auto command.
     ...
     * subsystems. Once end runs the command will no longer be in the command
     * scheduler loop.
